...
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('684bee08-a78d-4b1f-87a8-91910ca81f38', 'I', '{"cn":"加载xyz","en":"Load Xyz"}', '-', '1.0.0', '#8e294a', 'Build Struct', '{"web":[{"var":"xyz_file_path","name":{"cn":"分子文件","en":"molecule_files"},"description":"","ui":{"mpi_files":""}}]}', '{"downstream":[{"var":"xyz_file_path","name":{"cn":"Structure","en":"Structure"},"description":"","default_value":"${xyz_file_path}.xyz"}],"web":[]}', '', '', '{"name":"","email":""}', '', null);
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('b2e1e7e2-2b2a-4e2a-8e2a-2b2a4e2a8e2a', 'D', '{"cn":"分子预览","en":"Molecule Preview"}', '-', '1.0.0', '#a1a109', '', '{"upstream":[{"var":"xyz_file_path","name":{"cn":"Structure","en":"Structure"},"description":""}],"web":[{"var":"model_arr","name":{"cn":"文件","en":"File"},"description":"","ui":{"structure":""}}]}', '{"downstream":[],"web":[]}', '', '', '{"name":"","email":""}', '', null);
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('c3f2e8e3-3c3f-4e3c-9e3c-3c3f4e3c9e3c', 'C', '{"cn":"Hartree-Fock","en":"Hartree-Fock"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"xyz_file_path","name":{"cn":"Structure","en":"Structure"},"description":""}],"web":[{"var":"basis","name":{"cn":"基组","en":"basis"},"description":"常见基组示例：\\"sto-3g\\"：最小基组，快速但粗糙。\\"6-31g\\"：中等精度，常用于有机分子。","ui":{"options":["631g","sto-3g"]},"default_value":"631g"},{"var":"unit","name":{"cn":"单位","en":"unit"},"description":"","ui":{"options":["Angstrom","Bohr"]},"default_value":"Angstrom"}]}', '{"downstream":[{"var":"mol_file_path","name":{"cn":"SCF","en":"SCF"},"description":"","default_value":"structure-mol.chk"},{"var":"hf_energy_file_path","name":{"cn":"HF Energy","en":"HF Energy"},"description":"","default_value":"structure-hf-energy.json"}],"web":[]}', '', '', '{"name":"","email":""}', 'python /opt/script/hatree_fock_script.py --config_path ${input_config_path}', 'miqroera01/miqroforge_qsci_workflow:v1.1');
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('d4e3f9f4-4d4e-5f4d-af4d-4d4e5f4daf4d', 'C', '{"cn":"Pre-UCJ","en":"Pre-UCJ"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"mol_file_path","name":{"cn":"SCF","en":"SCF"},"description":""}],"web":[{"var":"activate_electrons","name":{"cn":"活跃电子数","en":"active_elec"},"description":"","ui":{"string":""},"default_value":"[3,3]"},{"var":"activate_orbit","name":{"cn":"活化轨道","en":"active_orbit"},"description":"","ui":{"text":""},"default_value":"[3,4,5,6,7,8,9,10,11]"}]}', '{"downstream":[{"var":"ccsd_file_path","name":{"cn":"CCSD.t2","en":"CCSD.t2"},"description":"","default_value":"structure-ccsd.chk"},{"var":"ffsim_file_path","name":{"cn":"Mol Data","en":"Mol Data"},"description":"","default_value":"structure-ffsim.json"}],"web":[]}', '', '', '{"name":"","email":""}', 'python /opt/script/pre_ucj_script.py --config_path ${input_config_path}', 'miqroera01/miqroforge_qsci_workflow:v1.1');
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('e5f4g0g5-5e5f-6g5e-bg5e-5e5f6g5ebg5e', 'C', '{"cn":"UCJ","en":"UCJ"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"ccsd_file_path","name":{"cn":"CCSD.t2","en":"CCSD.t2"},"description":""}],"web":[{"var":"circuit_repeats","name":{"cn":"电路重复次数","en":"n_reps"},"description":"","ui":{"number":""},"default_value":2}]}', '{"downstream":[{"var":"qasm_code_file_path","name":{"cn":"QC","en":"QC"},"description":"","default_value":"structure-qasm.txt"}],"web":[]}', '', '', '{"name":"","email":""}', 'python /opt/script/ucj_script.py --config_path ${input_config_path}', 'miqroera01/miqroforge_qsci_workflow:v1.1');
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('f6g5h1h6-6f6g-7h6f-ch6f-6f6g7h6fch6f', 'C', '{"cn":"1号量子计算机","en":"Quantum Computer No.1"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"qasm_code_file_path","name":{"cn":"QC","en":"QC"},"description":"","default_value":""}],"web":[{"var":"shots","name":{"cn":"测量次数","en":"shots"},"description":"","ui":{"number":""},"default_value":10000},{"var":"image_url","name":{"cn":"","en":""},"description":"","ui":{"image":""},"default_value":"http://139.196.211.120:6701/api/file/download?fileName=miqroforge/task/20250729/b5543f11526044bba3c8e8aa8f436bd8/quantum-dark.png,http://139.196.211.120:6701/api/file/download?fileName=miqroforge/task/20250729/4ba5e70538c54551a547ad20cb3ae13f/quantum-light.png"}]}', '{"downstream":[{"var":"measure_counts_file_path","name":{"cn":"Measure Result","en":"Measure Result"},"description":"","default_value":"structure-measure-counts.json"}],"web":[]}', '', '', '{"name":"","email":""}', 'python /opt/script/simulator_script.py --config_path ${input_config_path}', 'miqroera01/miqroforge_qsci_workflow:v1.1');
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('g7h6i2i7-7g7h-8i7g-di7g-7g7h8i7gdi7g', 'C', '{"cn":"QSCI","en":"QSCI"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"measure_counts_file_path","name":{"cn":"Measure Result","en":"Measure Result"},"description":""},{"var":"ffsim_file_path","name":{"cn":"Mol Data","en":"Mol Data"},"description":""},{"var":"hf_energy_file_path","name":{"cn":"HF Energy","en":"HF Energy"},"description":"","default_value":"structure-hf-energy.json"}],"web":[{"var":"iterator_number","name":{"cn":"总迭代次数","en":"iter"},"description":"","ui":{"number":""},"default_value":5},{"var":"unique_sample","name":{"cn":"唯一样本数","en":"n_uni_samples"},"description":"","ui":{"prompt_string":["default"]},"default_value":"default"},{"var":"batch_sample_number","name":{"cn":"每批样本数","en":"sbatch"},"description":"","ui":{"prompt_string":["default"]},"default_value":"default"},{"var":"batch_number","name":{"cn":"批次数","en":"nbatch"},"description":"","ui":{"prompt_string":["default"]},"default_value":"default"}]}', '{"downstream":[{"var":"qsci_energy_file_path","name":{"cn":"Energy","en":"Energy"},"description":"","default_value":"structure-qsci-energy.json"}],"web":[]}', '', '', '{"name":"","email":""}', 'python /opt/script/sqd_script.py --config_path ${input_config_path}', 'miqroera01/miqroforge_qsci_workflow:v1.1');
INSERT INTO node (id, type, name, description, version, color, tag, input, output, performance_config_path, example_config_path, contact, execution_command, image) VALUES ('h8i7j3j8-8h8i-9j8h-ej8h-8h8i9j8hej8h', 'D', '{"cn":"能量结果","en":"Energy Result"}', '-', '1.0.0', '', '', '{"upstream":[{"var":"energy1","name":{"cn":"Energy1","en":"Energy1"},"description":"","is_resolved":true,"order_by":"bond_length","is_asc":true},{"var":"energy2","name":{"cn":"Energy2","en":"Energy2"},"description":""}],"web":[{"var":"energy","name":{"cn":"固定值","en":"fixed_value"},"description":"","ui":{"echarts":""}}]}', '{"downstream":[],"web":[]}', '', '', '{"name":"","email":""}', '', null);
